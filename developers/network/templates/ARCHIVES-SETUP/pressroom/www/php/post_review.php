				...
				<div class="horizontal_carousel_container small">
					<ul class="blog horizontal_carousel autoplay-1 scroll-1 visible-3 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							...
							<h5><a href="?page=post_small_image" title="High Altitudes May Aid Weight Control">High Altitudes May Aid Weight Control</a></h5>
							<ul class="post_details simple">
								<li class="category"><a href="?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
								<li class="date">
									10:11 PM, Feb 02
						...
						<li class="post first">
							...
							<h5><a href="?page=post_quote" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a></h5>
							<ul class="post_details simple">
								<li class="category"><a href="?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
								<li class="date">
									10:11 PM, Feb 02
		...
		<div class="row page_margin_top">
			<div class="column column_2_3">
						...
						<div class="review_block clearfix">
							<div class="column column_1_2">
								<ul class="review_chart">
									<li>
										<h5 class="margin_top_0">Design Quality</h5>
										<div class="value_container">
											<div class="value_bar_container">
												<div class="value_bar animated_element animation-width duration-2000">
													<span class="number tens" data-value="8.5"></span>
												</div>
											</div>
										</div>
									</li>
									<li>
										<h5 class="margin_top_0">Code Quality</h5>
										<div class="value_container">
											<div class="value_bar_container">
												<div class="value_bar animated_element animation-width duration-2000">
													<span class="number tens" data-value="7.2"></span>
												</div>
											</div>
										</div>
									</li>
									<li>
										<h5 class="margin_top_0">Uniqueness</h5>
										<div class="value_container">
											<div class="value_bar_container">
												<div class="value_bar animated_element animation-width duration-2000">
													<span class="number tens" data-value="8.0"></span>
												</div>
											</div>
										</div>
									</li>
									<li>
										<h5 class="margin_top_0">Support Quality</h5>
										<div class="value_container">
											<div class="value_bar_container">
												<div class="value_bar animated_element animation-width duration-2000">
													<span class="number tens" data-value="9.2"></span>
												</div>
											</div>
										</div>
									</li>
							...
							<div class="column column_1_2">
								<h5 class="margin_top_0">Pros</h5>
								<ul class="list margin_top_10">
									<li class="bullet style_3">New England Governors</li>
									<li class="bullet style_3">West Coast Governors Global</li>
									<li class="bullet style_3">Loreal dosis adiscipling cuprum</li>
								</ul>
								<h5 class="page_margin_top_section">Cons</h5>
								<ul class="list margin_top_10">
									<li class="bullet style_4">New England Governors</li>
									<li class="bullet style_4">West Coast Governors Global</li>
									<li class="bullet style_4">Norma grandiva social</li>
								</ul>
							</div>
						</div>
						<div class="review_summary margin_top_10 clearfix">
							<div class="number tens" data-value="8.2"></div>
							<div class="text">
								<h4 class="margin_top_0">Solid Dose of Fun</h4>
								<p>Politicians have looked weak in the face of such natural disaster, with many facing criticism from local residents for doing little more than turning up as flood tourists at the site of disasters.</p>
							</div>
						</div>
						<div class="post_content page_margin_top_section clearfix">
							<div class="content_box">
								...
								<div class="text">
									...
									<a title="6 Comments" href="?page=post" class="read_more page_margin_top scroll_to_comments"><span class="arrow"></span><span>6 COMMENTS</span></a>
								</div>
							</div>
				...
				<div class="row page_margin_top_section">
					...
					<div class="horizontal_carousel_container page_margin_top">
						<ul class="blog horizontal_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
							<li class="post">
								<a href="?page=post_quote_2" title="New Painkiller Rekindles Addiction Concerns">
									<img src='images/samples/330x242/image_08.jpg' alt='img'>
								</a>
								<h5><a href="?page=post_quote_2" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a></h5>
								<ul class="post_details simple">
									<li class="category"><a href="?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
									<li class="date">
										10:11 PM, Feb 02
				...
				<div class="row page_margin_top_section">
					...
					<form class="comment_form margin_top_15" id="comment_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
			...
			<div class="column column_1_3">
				...
				<div class="vertical_carousel_container clearfix">
					<ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							<a href="?page=post_soundcloud" title="Nuclear Fusion Closer to Becoming a Reality">
								<img src='images/samples/100x100/image_13.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="?page=post_soundcloud" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
									<li class="date">
				...
				<div class="horizontal_carousel_container big page_margin_top">
					<ul class="blog horizontal_carousel visible-1 autoplay-0 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							<a href="?page=post_video_2" title="Built on Brotherhood, Club Lives Up to Name">
								<span class="icon video"></span>
								<img src='images/samples/330x242/image_14.jpg' alt='img'>
							</a>
							<h5 class="with_number">
								<a href="?page=post_video_2" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a>
						...
						<li class="post">
							<a href="?page=post_video" title="New Painkiller Rekindles Addiction Concerns">
								<span class="icon video"></span>
								<img src='images/samples/330x242/image_04.jpg' alt='img'>
							</a>
							<h5 class="with_number">
								<a href="?page=post_video" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a>
								<a class="comments_number" href="?page=post_video#comments_list" title="2 comments">2<span class="arrow_comments"></span></a>
							</h5>
							<ul class="post_details simple">
								<li class="category"><a href="?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>

<div class="page">
	<div class="page_header clearfix page_margin_top">
		<div class="page_header_left">
			<h1 class="page_title">'<?php echo $_GET["s"]; ?>'</h1>
		</div>
	...
	<div class="page_layout clearfix">
		...
		<div class="row page_margin_top">
			<div class="column column_2_3">
				<div class="row">
					<h4 class="box_header">Search Results For '<?php echo $_GET["s"]; ?>' (12)</h4>
					<form method="get" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>" class="search_form page_margin_top">
						<input class="text_input" name="s" type="text" value="<?php echo htmlspecialchars($_GET["s"]); ?>" placeholder="Search...">
				...
				<div class="row">
					...
					<ul class="blog column column_1_2">
						...
						<li class="post">
							<a href="?page=post_quote" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">
								<img src='images/samples/330x242/image_05.jpg' alt='img'>
							</a>
							<h2 class="with_number">
								<a href="?page=post_quote" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">Study Linking Illnes and Salt Leaves Researchers Doubtful</a>
						...
						<ul class="blog rating page_margin_top clearfix">
							...
							<li class="post">
								<div class="post_content">
									...
									<h5><a href="?page=post_quote_2" title="Syrian Civilians Trapped for Months Continue to be Evacuated">Syrian Civilians Trapped for Months Continue to be Evacuated</a></h5>
									<ul class="post_details simple">
										<li class="category"><a href="?page=category&amp;cat=science" title="SCIENCE">SCIENCE</a></li>
									</ul>
								</div>

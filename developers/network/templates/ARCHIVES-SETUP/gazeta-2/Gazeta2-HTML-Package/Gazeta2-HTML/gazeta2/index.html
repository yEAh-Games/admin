...
<div class="container wrapper">
			...
			<div class="row">
				<div class="col-md-3 b1-aside">
					...
					<div class="bla-content">
						<span class="cat-default">Tech</span>
						<p><i class="fa fa-clock-o"></i> December 13, 2014</p>
						<h4><a href="./news_single.html">Tempor Cum Soluta Nobis Eleifend Option Congue Nihil</a></h4>
						<div class="sep"></div>
					...
					<div class="cat-blocks">
						...
						<div class="row">
							...
							<div class="col-md-6 cb-info">
								...
								<span class="date"><i class="fa fa-clock-o"></i> December 13,2014 <a href="#"><i class="fa fa-comments"></i> 5</a></span>
								<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt laoreet dolore</p>
								<ul>
									<li><a href="./news_single.html">Envato's Most Wanted - Pagewiz Landing Page Templates - $14,000</a></li>
									<li><a href="./news_single.html">Item Support: Feeding back key dataand insights from the surveys</a></li>
									<li><a href="./news_single.html">In progress - Our knowledge base will be unavailable for maintenance</a></li>
								</ul>
							</div>
						</div>
	...
	<footer class="container">
		...
		<div class="col-md-3 footer-widget">
			<h5><span>Text Widget</span></h5>
			<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor  duis sed odio sit.</p>
			<div class="space15"></div>
			<p>amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare </p>
		</div>
		<div class="col-md-3 footer-widget">
			<h5><span>Flickr Gallery</span></h5>
			<ul id="flickr" class="thumbs"></ul>
		</div>
		<div class="col-md-3 footer-widget">
			<h5><span>Facebook Widget</span></h5>
	...
	<div class="footer-bottom">
		<div class="container">
			...
			<p>&copy; Copyright Gazeta  -  All rights reserved.<br>Registered in Melbourne, No 13245678. Registered Office: ENVATO Graphics Ltd. 4 Royton Square, Bakewell Road, Orton Westgate, Melbourne PE1 2GX.</p>

<div class="page">
	<div class="page_header clearfix page_margin_top">
		<div class="page_header_left">
			<h1 class="page_title">Blog Small Slider</h1>
		</div>
	...
	<div class="page_layout clearfix">
		...
		<div class="row page_margin_top">
			<div class="column column_2_3">
					...
					<ul class="small_slider id-small_slider">
						...
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="?page=post" title="Nuclear Fusion Closer to Becoming a Reality">Climate Change Debate While Britain Floods</a></h2>
								<p class="clearfix">Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
							</div>
						</li>
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="?page=post" title="Nuclear Fusion Closer to Becoming a Reality">The Public Health Crisis Hiding in Our Food</a></h2>
								<p class="clearfix">Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
							</div>
						</li>
						<li class="slide">
							...
							<div class="slider_content_box">
								...
								<h2><a href="?page=post" title="Nuclear Fusion Closer to Becoming a Reality">Built on Brotherhood, Club Lives Up to Name</a></h2>
								<p class="clearfix">Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.</p>
							</div>
						</li>
					</ul>
				...
				<h4 class="box_header page_margin_top">All Posts From World</h4>
				<div class="row">
			...
			<div class="column column_1_3">
				...
				<div class="vertical_carousel_container clearfix">
					<ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
						...
						<li class="post">
							<a href="?page=post_quote_2" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">
								<img src='images/samples/100x100/image_12.jpg' alt='img'>
							</a>
							<div class="post_content">
								<h5>
									<a href="?page=post_quote_2" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">Syrian Civilians Trapped For Months Continue To Be Evacuated</a>
								</h5>
								<ul class="post_details simple">
									<li class="category"><a href="?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
									<li class="date">
